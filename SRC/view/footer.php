            ...
            <div class="row">
                ...
                <div class="col-6 col-md-3 mb-3 col-lg-3">
                    ...
                    <ul class="nav flex-column">
                        <li class="nav-item mb-2"><a href="main.php" class="nav-link p-0 text-muted">Home</a></li>
                        <li class="nav-item mb-2"><a href="aboutus.php" class="nav-link p-0 text-muted">About Us</a></li>
                        <li class="nav-item mb-2"><a href="expertcorner.php" class="nav-link p-0 text-muted">Expert Corner</a></li>
                ...
                <div class="col-12 col-md-3 mb-3 col-lg-3">
                    <form>
                        <h5>Our Page</h5>
                        <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fthongtinchinhphu&tabs=timeline&width=300&height=250&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="300" height="250" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>
                    </form>
                </div>
            </div>
        </footer>
