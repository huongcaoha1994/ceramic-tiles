                        ...
                        <div class="container-product">
                          ...
                          ?>
                            ...
                            <div class="col-6 col-lg-3 my-2">
                              <div class="card h-100">
                                <img src="<?php echo $row['image']; ?>" class="card-img-top" height="150px" width="150px" alt="Laptop" />
                                <div class="card-body">
                                  <div class="d-flex justify-content-between mb-3">
                          ...
                          <?php
                            $count++;
                            if ($count % 4 == 0) {
                              echo '</div><div class="container-product">'; /* Đóng container và mở container mới sau khi hiển thị 4 div */
                            }
                          }
                          ?>
                        </div>
